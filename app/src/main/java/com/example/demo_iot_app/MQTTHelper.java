...
public class MQTTHelper {
    ...
    public final String[] arrayTopics = {"khanhhuy03/feeds/cambien1", "khanhhuy03/feeds/cambien2","khanhhuy03/feeds/nutnhan1", "khanhhuy03/feeds/nutnhan2"};

    final String clientId = "Huy03";
    final String username = "khanhhuy03";
    final String password = "aio_DWIH71diAOBNcrOyNAQVheWLIkQI";
